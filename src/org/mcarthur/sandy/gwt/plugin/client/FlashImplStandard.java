...
/**
 * W3C Standard version of FlashImpl.
 *
 * @author Sandy McArthur
 * @see <a href="http://devedge-temp.mozilla.org/viewsource/2002/scripting-flash/#object">Scripting The Flash Player Plugin</a>
 */
class FlashImplStandard extends FlashImpl {
    ...
    private Element swLiveConnectParam;
    public void updateSwLiveConnect() {
        if (swLiveConnectParam == null) {
            swLiveConnectParam = createParam("swliveconnect");
            DOM.appendChild(base, swLiveConnectParam);
        }
        setAttribute(swLiveConnectParam, "value", Boolean.toString(flash.isSwLiveConnect()));
    }
