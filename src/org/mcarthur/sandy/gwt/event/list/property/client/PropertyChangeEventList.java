...
import org.mcarthur.sandy.gwt.event.list.client.WrappedEventList;
 ...
 */
public final class PropertyChangeEventList extends WrappedEventList implements EventList {
    ...
    private class PropertyChangeEventListListener implements PropertyChangeListener {
        public void propertyChange(final PropertyChangeEvent evt) {
            ...
            for (i=0; i < size; i++) {
                if (o == get(i)) {
                    fireListEvent(new ListEvent(PropertyChangeEventList.this, ListEvent.CHANGED, i));
                    break;
                }
            }
            // TODO: remove this after testing
            if (i == size) {
                throw new IllegalStateException("List listening to an element not in list.");
            }
        }
    }
}
